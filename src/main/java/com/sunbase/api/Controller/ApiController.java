...
public class ApiController {
    ...
    public RedirectView updateCustomer(@ModelAttribute Customer customer, HttpServletRequest request){
        ...
        System.out.println(customer);
        String updateUrl = "https://qa.sunbasedata.com/sunbase/portal/api/assignment.jsp?cmd=update&uuid="+customer.getUuid();
    ...
    public RedirectView delete(@PathVariable String id, HttpServletRequest request){
        ...
        System.out.println(id);
        id = "https://qa.sunbasedata.com/sunbase/portal/api/assignment.jsp?cmd=delete&uuid="+id;
